...
ggsave(file.path(FIG_DIR, "Fig7c_RsoilModels_Robust_AnnualSums.png"), p_annual, width=9, height=5, dpi=150, bg="white")
...
ggsave(file.path(FIG_DIR, "Fig7d_RsoilModels_Robust_ObsVsPred.png"), p_sc, width=11, height=6, dpi=150, bg="white")

# Residual ACF (All model, example)
resids <- preds_out %>% mutate(res_All = Pred_All - meanRsoil)
png(file.path(FIG_DIR, "Fig_Diagnostics_ACF_All.png"), width=800, height=500, bg="white")
...
if (PLOT_RESIDUALS) {
  ...
  ggsave(file.path(FIG_DIR, "Fig_Diagnostics_ResvsFitted_All.png"), p1, width=6, height=4, dpi=150, bg="white")
  ggsave(file.path(FIG_DIR, "Fig_Diagnostics_ResvsSWC_All.png"),   p2, width=6, height=4, dpi=150, bg="white")
  ggsave(file.path(FIG_DIR, "Fig_Diagnostics_ResvsTsoil_All.png"), p3, width=6, height=4, dpi=150, bg="white")
  ggsave(file.path(FIG_DIR, "Fig_Diagnostics_QQ_All.png"),         p4, width=6, height=4, dpi=150, bg="white")
}
