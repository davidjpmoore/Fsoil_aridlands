...
ggsave(file.path(fig_dir, "Fig7a_RsoilModels_AnnualSums.png"), p_annual, width=8, height=5, dpi=150, bg="white")
...
ggsave(file.path(fig_dir, "Fig7b_RsoilModels_ObsVsPred.png"), p_scatter, width=8, height=6, dpi=150, bg="white")
